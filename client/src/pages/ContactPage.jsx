        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            <textarea
              ...
              className="w-full px-4 py-3.5 rounded-xl bg-zinc-50 border border-zinc-200 text-zinc-800 text-sm placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-[#FFD700]/50 transition-all resize-none"
              required
            />
            <motion.button
              type="submit"
          ...
          <div className="flex gap-3">
            {socialLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className={`flex-1 flex flex-col items-center gap-2 py-3 rounded-xl bg-zinc-900 text-zinc-400 border border-white/[0.06] ${link.color} hover:text-white transition-all duration-300 group`}
              >
