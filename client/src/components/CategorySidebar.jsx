...
function CategoryButton({ cat, index, activeCategory, onCategoryChange, categoryNames, emojis }) {
  ...
  return (
    <motion.button
      ...
      className={`w-full py-3 px-2 rounded-2xl text-center transition-all duration-200 ${
        isActive
...
const MemoCategoryButton = React.memo(CategoryButton);
